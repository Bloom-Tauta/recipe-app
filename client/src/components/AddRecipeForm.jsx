...
//                     <input type='text' id='recipename' value={recipeName} onChange={(e) => handleRecipeNameChange (e)}  className="outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm focus:ring-primary-600 p-2 "placeholder='recipe name' required/>
//                   </div>
//                   <div className='flex flex-col'>
